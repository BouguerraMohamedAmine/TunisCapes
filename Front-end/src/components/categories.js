  ...
  const categoryData = [
    {
      ...
      endpoint: 'http://192.168.100.42:3000/hotels',
    },
    {
      name: 'seas',
      coverImage: require('../../assets/seatn.png'),
      endpoint: 'http://192.168.100.42:3000/seas',
    },
    {
      name: 'mountains',
      coverImage: require('../../assets/mountaintn.jpg'),
      endpoint: 'http://192.168.100.42:3000/mou',
    },
    {
      name: 'monuments',
      coverImage: require('../../assets/mounumenttn.jpg'),
      endpoint: 'http://192.168.100.42:3000/monuments',
    },
    {
      name: 'museums',
      coverImage: require('../../assets/musemtn.jpg'),
      endpoint: 'http://192.168.100.42:3000/museums',
    },
    {
      name: 'Deserts',
      coverImage: require('../../assets/deserttn.jpg'),
      endpoint: 'http://192.168.100.42:3000/deserts',
    },
  ];
