...
const Categories = () => {
  ...
  const categoryData = [
    {
      ...
      endpoint: 'http://192.168.100.47:3000/hotels',
    },
    {
      name: 'seas',
      coverImage: require('../../assets/images/sea.png'),
      endpoint: 'http://192.168.100.47:3000/seas',
    },
    {
      name: 'mountains',
      coverImage: require('../../assets/images/mountin.png'),
      endpoint: 'http://192.168.100.47:3000/mou',
    },
    {
      name: 'monuments',
      coverImage: require('../../assets/images/monument.png'),
      endpoint: 'http://192.168.100.47:3000/monuments',
    },
    {
      name: 'museums',
      coverImage: require('../../assets/images/musems.png'),
      endpoint: 'http://192.168.100.47:3000/museums',
    },
    {
      name: 'Deserts',
      coverImage: require('../../assets/images/desertjpg.jpg'),
      endpoint: 'http://192.168.100.47:3000/deserts',
    },
  ];
  ...
  useEffect(() => {
    ...
    axios.get('http://192.168.100.47:3000/cities')
      .then((response) => {
