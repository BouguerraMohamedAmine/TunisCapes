...
const Blog = () => {
  ...
  const fetchBlogPosts = async () => {
    try {
      const response = await axios.get("http://192.168.100.42:3000/blogs"); // Replace with your server URL
  ...
  const handlePost = async () => {
    ...
    try {
      const response = await axios.post(
        "http://192.168.100.42:3000/blogs", // Replace with your server URL
        newBlogPost
      );
  ...
  const updatePost = async () => {
    ...
    try {
      const response = await axios.put(
        `http://192.168.100.42:3000/blogs/${updatedPost._id}`, // Replace with your server URL
        updatedPost
      );
  ...
  const deletePost = async () => {
    ...
    try {
      const response = await axios.delete(
        `http://192.168.100.42:3000/blogs/${selectedPost._id}` // Replace with your server URL
      );
