...
const handleSignIn = async () => {
  try {
    ...
    const authResponse = await axios.post('http://192.168.100.50:3000/users/login', {
      email,
      password,
    });
    ...
    if (authResponse.status === 200) {
      ...
      const userResponse = await axios.get(`http://192.168.100.50:3000/users/email/${userEmail}`, {
        headers: {
